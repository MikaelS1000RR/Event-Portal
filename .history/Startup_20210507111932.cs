...
.AddJwtBearer(jwtOptions =>
{
  ...
  jwtOptions.TokenValidationParameters.Validaet
  jwtOptions.TokenValidationParameters.ValidateIssuerSigningKey = true; 
  jwtOptions.TokenValidationParameters.ValidIssuer = Configuration["Jwt:Issuer"];
  jwtOptions.TokenValidationParameters.ValidAudience = Configuration["Jwt:Audience"];
  jwtOptions.TokenValidationParameters.IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(Configuration["Jwt:Key"]));
});
services.AddMvc();
